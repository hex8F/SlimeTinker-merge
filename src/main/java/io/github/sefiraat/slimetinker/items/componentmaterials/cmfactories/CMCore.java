...
public final class CMCore {
    ...
    public static void setupToolConsumers() {
        ...
        map.get(IDStrings.REINFORCED).addEvent(TraitEventType.DURABILITY, TraitPartType.HEAD, EntityDamageEvents::rodOsmium);               // MOD: Heavy Pommel (SFWarfare)
        ...
        map.get(IDStrings.SILVER).addEvent(TraitEventType.TICK, TraitPartType.HEAD, TickEvents::rodSingGold);                               // MOD: All That Glitters II (Infinity)                                                                                                         // Enchanting (Special case - in Experience.java - could be moved if I raise an event)
        map.get(IDStrings.BILLON).addEvent(TraitEventType.TICK, TraitPartType.HEAD, TickEvents::rodStarDust);                               // MOD: Yvaine (Dyna)
        ...
        map.get(IDStrings.HARD).addEvent(TraitEventType.DURABILITY, TraitPartType.ROD, DurabilityEvents::headAdvancedAlloy);                // MOD: Heavy Duty (LiteX)
